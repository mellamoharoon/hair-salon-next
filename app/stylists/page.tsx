        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="body-lg text-salon-700 mb-0">
              Our team of talented professionals combines artistry with
              technical expertise to create looks that enhance your natural
              beauty.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
            {stylists.map((stylist) => (
              <div key={stylist.id} className="group">
                ...
                <p className="text-salon-600 mb-4 line-clamp-3">
                  {stylist.bio}
                </p>

                <div className="mb-4">
                  <h3 className="text-sm font-medium uppercase text-salon-700 mb-2">
                    Specialties
                  </h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      className="text-salon-400 hover:text-salon-700 transition-colors"
                    >
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="body-base mb-8 text-salon-200">
              We&apos;re always looking for talented stylists to join our team.
              If you&apos;re passionate about hair, committed to excellence, and
              want to be part of a collaborative salon culture, we&apos;d love
              to hear from you.
            </p>
            <Link
              href="/careers"
