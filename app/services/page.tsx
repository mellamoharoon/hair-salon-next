  ...
  const services = [
    {
      ...
      description: 'Our expert stylists provide precision cuts tailored to your face shape, lifestyle, and personal style. From classic to avant-garde, we craft the perfect look for you.',
      items: [
    ...
    },
    {
      id: 'coloring',
      title: 'Hair Coloring',
      description: 'Transform your look with our premium color services. We use high-quality, ammonia-free products to minimize damage while achieving vibrant, long-lasting results.',
      items: [
    ...
    },
    {
      ...
      description: 'Revitalize and nourish your hair with our specialized treatments. Ideal for addressing damage, enhancing shine, or managing specific hair concerns.',
      items: [
    ...
    },
    {
      ...
      description: 'Add length, volume, or both with our premium hair extensions. We offer various methods to suit your lifestyle and hair type, using only the finest quality hair.',
      items: [
      ...
      image: 'https://images.pexels.com/photos/3993467/pexels-photo-3993467.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
    },
    {
      id: 'bridal',
      title: 'Bridal Services',
      description: 'Make your special day even more memorable with our comprehensive bridal services. We offer trials, day-of styling, and packages for the entire wedding party.',
      items: [
      ...
      image: 'https://images.pexels.com/photos/4614230/pexels-photo-4614230.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
    }
  ]
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="body-lg text-salon-700 mb-0">
              Experience the Elegance difference with our comprehensive range of premium hair services, each delivered with exceptional skill and personalized attention.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <div className={`${index % 2 === 1 ? 'lg:order-2' : 'lg:order-1'}`}>
                    ...
                    <div className="space-y-4 mb-8">
                      {service.items.map((item, i) => (
                        <div key={i} className="flex justify-between items-center pb-2 border-b border-salon-200">
                    ...
                    <Link href="/booking" className="inline-block px-6 py-3 bg-salon-700 text-white rounded-md hover:bg-salon-800 transition-colors">
                      Book This Service
                    </Link>
                  </div>
                  
                  <div className={`relative h-[400px] ${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'}`}>
                    <Image
                      src={service.image}
                      alt={service.title}
                      fill
      ...
      <section className="py-20 bg-salon-700 text-white">
        <div className="container text-center">
          ...
          <p className="body-lg mb-8 max-w-2xl mx-auto text-salon-100">
            Our team of expert stylists is ready to create the look you've always wanted. Book your appointment today.
          </p>
          <Link href="/booking" className="inline-block px-8 py-4 bg-white text-salon-800 rounded-md hover:bg-salon-100 transition-colors font-medium">
